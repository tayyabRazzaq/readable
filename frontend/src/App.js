        ...
        const categoriesList = categories.map(category => {
            ...
            return (
                <ListItem
                    ...
                    <ListItemText inset primary={category.name} className={classes.ListItem} disableTypography/>
                </ListItem>
            );
        });
                ...
                <nav className={navBarStyling.join(' ')}>
                    <List className={classes.navList} component="nav">
                        <ListItem
                            ...
                            className={navItemClasses.join(' ')}>
                            <ListItemText inset primary="All" className={classes.ListItem} disableTypography/>
                        </ListItem>
                        {categoriesList}
                    </List>
                </nav>
